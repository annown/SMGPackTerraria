...
{
    public class SpiderBombProj : ModProjectile
	{
		public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Spider Bomb");
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            {
                target.AddBuff(ModContent.BuffType<Buffs.BoneBleed>(), 120);
            }
        }
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(projectile.Center, projectile.Center * 1.5f, mod.ProjectileType("SpiderBombSpider"), 22, 2f, Main.myPlayer);
            Projectile.NewProjectile(projectile.Center, projectile.Center * 1.5f, mod.ProjectileType("SpiderBombSpider"), 22, 2f, Main.myPlayer);
            Projectile.NewProjectile(projectile.Center, projectile.Center * 1.5f, mod.ProjectileType("SpiderBombSpider"), 22, 2f, Main.myPlayer);
        }
    }
